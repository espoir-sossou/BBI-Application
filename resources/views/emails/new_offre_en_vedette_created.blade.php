...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <ul>
                <li><span class="highlight">Titre de l'annonce :</span> {{ $OffreEnVedette->titre }}</li>
                <li><span class="highlight">Description :</span> {{ $OffreEnVedette->description }}</li>
                <li><span class="highlight">Montant :</span> {{ number_format($OffreEnVedette->prix, 2, ',', ' ') }} FCFA</li>
                <li><span class="highlight">Localité :</span> {{ $OffreEnVedette->localite }}</li>
                <li><span class="highlight">Type de transaction :</span> {{ $OffreEnVedette->typeTransaction }}</li>
                <li><span class="highlight">Date de création :</span> {{ $OffreEnVedette->dateCreation->format('d-m-Y H:i') }}</li>
            </ul>
