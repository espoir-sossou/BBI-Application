...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        @include('Layout.Backend.Admin_dashboard.Partials.sidebar')

        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column">
            <!-- Main Content -->
            <div id="content">
                @include('Layout.Backend.Admin_dashboard.Partials.topbar')
                <!-- Begin Page Content -->
            ...
            @include('Layout.Backend.Admin_dashboard.Partials.footer')
        </div>
    </div>
