    ...
    <div class="row px-xl-5 pt-5">
        ...
        <div class="col-md-2 mb-5">
            ...
            <ul class="list-unstyled">
                ...
                <li><a class="text-secondary mb-2" href="{{ route('apropos') }}"><i class="fa fa-angle-right mr-2"></i>À propos de nous</a></li>
                <li><a class="text-secondary mb-2" href="{{ route('service') }}"><i class="fa fa-angle-right mr-2"></i>Nos Services</a></li>
                <li><a class="text-secondary" href="{{ route('contact') }}"><i class="fa fa-angle-right mr-2"></i>Contact</a></li>
            </ul>
        </div>
        ...
        <div class="col-md-2 mb-5">
            ...
            <ul class="list-unstyled">
                ...
                <li><a class="text-secondary mb-2" href="{{ route('service') }}"><i class="fa fa-angle-right mr-2"></i>Location de propriété</a></li>
        ...
        <div class="col-md-2 mb-5">
            ...
            <ul class="list-unstyled">
                <li><a class="text-secondary mb-2" href="{{ route('apropos') }}"><i class="fa fa-angle-right mr-2"></i>Notre Mission</a></li>
                <li><a class="text-secondary mb-2" href="{{ route('apropos') }}"><i class="fa fa-angle-right mr-2"></i>Notre Équipe</a></li>
                <li><a class="text-secondary mb-2" href="{{ route('apropos') }}"><i class="fa fa-angle-right mr-2"></i>Partenariats</a></li>
                <li><a class="text-secondary mb-2" href="{{ route('apropos') }}"><i class="fa fa-angle-right mr-2"></i>Témoignages</a></li>
                <li><a class="text-secondary" href="{{ route('apropos') }}"><i class="fa fa-angle-right mr-2"></i>Nos Réalisations</a></li>
            </ul>
        </div>
        ...
        <div class="col-md-2 mb-5">
            ...
            <ul class="list-unstyled">
                <li><a class="text-secondary" href="{{ route('contact') }}"><i class="fa fa-angle-right mr-2"></i>Contactez-nous</a></li>
            </ul>
        </div>
    </div>
