                    ...
                    <div class="col-lg-6 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="m-0">{{ $user->nom ?? 'Non spécifié' }}</p>
                            </div>
                        </div>
                    </div>
                    <!-- Prénom -->
                    <div class="col-lg-6 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="m-0">{{ $user->prenom ?? 'Non spécifié' }}</p>
                            </div>
                        </div>
                    </div>
                    <!-- Email -->
                    ...
                    <div class="col-lg-6 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="m-0">{{ $user->telephone ?? 'Non spécifié' }}</p>
                            </div>
                        </div>
                    </div>
                    <!-- Adresse -->
                    <div class="col-lg-6 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="m-0">{{ $user->adresse ?? 'Non spécifié' }}</p>
                            </div>
                        </div>
                    </div>
                    <!-- Rôle -->
                    <div class="col-lg-6 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="m-0">{{ ucfirst(strtolower($user->role)) }}</p>
                            </div>
                        </div>
                    </div>
                    <!-- Statut -->
