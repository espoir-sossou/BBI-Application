...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('Frontend/Home/assets/imgs/logo_bbi.png') }}" rel="icon">
    ...
    <!-- Vendor CSS Files -->
    <link href="{{ asset('Frontend/Lending/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('Frontend/Lending/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('Frontend/Lending/assets/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet">
    <link href="{{ asset('Frontend/Lending/assets/vendor/aos/aos.css') }}" rel="stylesheet">
    <link href="{{ asset('Frontend/Lending/assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
    <link href="{{ asset('Frontend/Lending/assets/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
    ...
    * License: https://bootstrapmade.com/license/
    ======================================================== -->
      ...
      <link href="{{ asset('Generales/Villa/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
