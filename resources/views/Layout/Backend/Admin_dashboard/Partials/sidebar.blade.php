  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('agence.dashboard') }}">
    ...
    <li class="nav-item">
        ...
        <div id="collapseAnnonces" class="collapse" aria-labelledby="headingAnnonces" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('admin.annonce.liste') }}">Liste des Annonces</a>
     ...
     <li class="nav-item">
        ...
        <div id="collapseAnnonces" class="collapse" aria-labelledby="headingAnnonces" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('admin.offreEnVedette.liste') }}">Liste des offres</a>
                <!-- Lien pour voir la liste des annonces -->
            </div>
        </div>
    </li>
