...
@section('content')
    ...
    <!-- Page level plugins -->
    <script src="{{ asset('Frontend/Home/assets/vendor/chart.js/Chart.min.js') }}"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('Frontend/Home/assets/js/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('Frontend/Home/assets/js/demo/chart-pie-demo.js') }}"></script>
@endsection
