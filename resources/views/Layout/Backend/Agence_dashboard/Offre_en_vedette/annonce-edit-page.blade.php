...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('offreEnVedette.update', $OffreEnVedette->offre_en_vedettes_id) }}" method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="titre" name="titre"
                    value="{{ old('titre', $OffreEnVedette->titre) }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="montant" name="montant"
                    value="{{ old('montant', $OffreEnVedette->montant) }}" required min="0">
            </div>

            <div class="form-group">
                <label for="typePropriete">Type de Propriété</label>
                <select class="form-control" id="typePropriete" name="typePropriete" required>
                    <option value="Appartement" {{ $OffreEnVedette->typePropriete == 'Appartement' ? 'selected' : '' }}>
                        Appartement</option>
                    <option value="Maison" {{ $OffreEnVedette->typePropriete == 'Maison' ? 'selected' : '' }}>Maison
                    </option>
                    <option value="Terrain" {{ $OffreEnVedette->typePropriete == 'Terrain' ? 'selected' : '' }}>Terrain
                    </option>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="nbSalleDeDouche" name="nbSalleDeDouche"
                    value="{{ old('nbSalleDeDouche', $OffreEnVedette->nbSalleDeDouche) }}" min="0">
            </div>

            <div class="form-group">
                <label for="localite">Localité</label>
                <input type="text" class="form-control" id="localite" name="localite"
                    value="{{ old('localite', $OffreEnVedette->localite) }}" required>
            </div>

            <div class="form-group">
                <label for="localisation">Localisation (Adresse)</label>
                <input type="text" class="form-control" id="localisation" name="localisation"
                    value="{{ old('localisation', $OffreEnVedette->localisation) }}">
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="typeTransaction" name="typeTransaction" required>
                    <option value="A vendre" {{ $OffreEnVedette->typeTransaction == 'A vendre' ? 'selected' : '' }}>A
                        vendre</option>
                    <option value="A louer" {{ $OffreEnVedette->typeTransaction == 'A louer' ? 'selected' : '' }}>A louer
                    </option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <div>
                    @php
                        $imagePath = $OffreEnVedette->image
                            ? Storage::url($OffreEnVedette->image)
