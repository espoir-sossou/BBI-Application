...
<body>
    ...
    <div class="container">
        ...
        <div class="panel messages-panel">
                        ...
                        <div class="contacts-outter">
                            <ul class="list-unstyled contacts">
                                @foreach ($conversations as $conversation)
                                    <li data-toggle="tab" data-target="#inbox-message-{{ $conversation['user']->id }}"
                                        class="conversation-item" data-user-id="{{ $conversation['user']->id }}">
                                        <img alt="" class="img-circle medium-image" src="https://bootdey.com/img/Content/avatar/avatar1.png" />
                                        <div class="vcentered info-combo">
                                            <h3 class="no-margin-bottom name">{{ $conversation['user']->email }}</h3>
                                            <h5>
                                                Dernier message : {{ Str::limit($conversation['messages']->last()->content, 40) }}
                                            </h5>
                                        </div>
                                    </li>
                                @endforeach
            ...
            <div class="tab-content">
                @foreach ($conversations as $conversation)
                    <div class="tab-pane message-body" id="inbox-message-{{ $conversation['user']->id }}">
                        ...
                        <div class="message-chat">
                            <div class="chat-body">
                                @foreach ($conversation['messages'] as $message)
                                    <div class="message {{ $message->sender_id === auth()->id() ? 'my-message' : 'info' }}">
                                        <img alt="" class="img-circle medium-image" src="https://bootdey.com/img/Content/avatar/avatar1.png" />
                                        <div class="message-body">
                                            <div class="message-info">
                                                <h4>
                                                    {{ $message->sender_id === auth()->id() ? 'Vous' : $conversation['user']->email }}
                                                </h4>
                                                <h5>
                                                    <i class="fa fa-clock-o"></i> {{ $message->created_at->format('H:i') }}
                                                </h5>
                                            </div>
                                            <hr />
                            ...
                            <div class="chat-footer">
                                <form action="{{ route('messages.store', $conversation['user']->user_id) }}" method="POST">
                                    @csrf
