                    ...
                    <div class="col-lg-6 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="m-0"><?php echo e($agent->nom ?? 'Non spécifié'); ?></p>
                            </div>
                        </div>
                    </div>
                    <!-- Prénom -->
                    <div class="col-lg-6 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="m-0"><?php echo e($agent->prenom ?? 'Non spécifié'); ?></p>
                            </div>
                        </div>
                    </div>
                    <!-- Email -->
                    <div class="col-lg-6 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="m-0"><?php echo e($agent->email); ?></p>
                            </div>
                        </div>
                    </div>
                    <!-- Téléphone -->
                    <div class="col-lg-6 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="m-0"><?php echo e($agent->telephone ?? 'Non spécifié'); ?></p>
                            </div>
                        </div>
                    </div>
                    <!-- Adresse -->
                    <div class="col-lg-6 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="m-0"><?php echo e($agent->adresse ?? 'Non spécifié'); ?></p>
                            </div>
                        </div>
                    </div>
                    <!-- Rôle -->
                    <div class="col-lg-6 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="m-0"><?php echo e(ucfirst(strtolower($agent->role))); ?></p>
                            </div>
                        </div>
                    </div>
                    <!-- Statut -->
                    <div class="col-lg-6 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <span class="badge <?php echo e($agent->status === 'active' ? 'bg-success' : 'bg-danger'); ?>">
...
<?php echo $__env->make('Layout.agence_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/espokeys/BBI/client/web/BBIAPP/BBI/resources/views/Layout/Connexion/Clients/agent-profile.blade.php ENDPATH**/ ?>