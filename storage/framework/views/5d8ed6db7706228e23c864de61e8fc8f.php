...
<html lang="en">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('Auberge/css/responsive.css')); ?>">
        ...
        <script src="<?php echo e(asset('Generales/js/headMaster_style.js')); ?>" defer></script>
        ...
        <link href="<?php echo e(asset('Generales/css/headMaster_style.css')); ?>" rel="stylesheet">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js"></script>
         ...
         <script src="<?php echo e(asset('Hotels/js/style.js')); ?>" defer></script>
...
<?php echo $__env->make('Layout.Frontend.Partials.loginPage.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home/espokeys/BBI/client/web/BBIAPP/BBI/resources/views/Layout/headMaster.blade.php ENDPATH**/ ?>