<?php $__env->startSection('content'); ?>
    <main id="main">
        ...
        <div class="breadcrumbs d-flex align-items-center"
            style="background-image: url('<?php echo e(asset('Frontend/Home/assets/imgs/aub25.jpg')); ?>');">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row justify-content-around gy-4">
                    ...
                    <div class="col-lg-6 img-bg"
                        style="background-image: url(<?php echo e(asset('Frontend/Home/assets/imgs/aub21.jpg')); ?>);"
                ...
                <div class="slides-2 swiper">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    <img src="<?php echo e(asset('Frontend/Home/assets/imgs/f5.jpg')); ?>" class="testimonial-img"
                                        alt="">
                                    <h3>Jean Dupont</h3>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    <img src="<?php echo e(asset('Frontend/Home/assets/imgs/h6.jpg')); ?>" class="testimonial-img"
                                        alt="">
                                    <h3>Marie Lemoine</h3>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    <img src="<?php echo e(asset('Frontend/Home/assets/imgs/f13.jpg')); ?>" class="testimonial-img"
                                        alt="">
                                    <h3>Aliou Traoré</h3>
                                    <h4>Entrepreneur</h4>
                                    <div class="stars">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    <img src="<?php echo e(asset('Frontend/Home/assets/imgs/h13.jpg')); ?>" class="testimonial-img"
                                        alt="">
                                    <h3>Sophie Martin</h3>
                                    <h4>Particulière</h4>
                                    <div class="stars">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    <img src="<?php echo e(asset('Frontend/Home/assets/imgs/h15.jpg')); ?>" class="testimonial-img"
                                        alt="">
...
<?php echo $__env->make('Layout.lending_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/espokeys/BBI/client/web/BBIAPP/BBI/resources/views/Layout/Frontend/Home/service-page.blade.php ENDPATH**/ ?>