...
<body>
    ...
    <div class="container">
        ...
        <div class="panel messages-panel">
            <div class="contacts-list">
                <div class="inbox-categories">
                    <div class="active" data-toggle="tab" data-target="#inbox">Inbox</div>
                        ...
                        <div class="contacts-outter">
                            <ul class="list-unstyled contacts">
                                <?php $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li data-toggle="tab" data-target="#inbox-message-<?php echo e($conversation['user']->id); ?>"
                                        class="conversation-item" data-user-id="<?php echo e($conversation['user']->id); ?>">
                                        <img alt="" class="img-circle medium-image" src="https://bootdey.com/img/Content/avatar/avatar1.png" />
                                        <div class="vcentered info-combo">
                                            <h3 class="no-margin-bottom name"><?php echo e($conversation['user']->email); ?></h3>
                                            <h5>
                                                Dernier message : <?php echo e(Str::limit($conversation['messages']->last()->content, 40)); ?>
            ...
            <div class="tab-content">
                <?php $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane message-body" id="inbox-message-<?php echo e($conversation['user']->id); ?>">
                        <div class="message-top">
                            <a href="" class="btn btn-success new-message">
                        ...
                        <div class="message-chat">
                            <div class="chat-body">
                                <?php $__currentLoopData = $conversation['messages']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="message <?php echo e($message->sender_id === auth()->id() ? 'my-message' : 'info'); ?>">
                                        <img alt="" class="img-circle medium-image" src="https://bootdey.com/img/Content/avatar/avatar1.png" />
                                        <div class="message-body">
                                            <div class="message-info">
                                                <h4>
                                                    <?php echo e($message->sender_id === auth()->id() ? 'Vous' : $conversation['user']->email); ?>

                                                </h4>
                                                <h5>
                                                    <i class="fa fa-clock-o"></i> <?php echo e($message->created_at->format('H:i')); ?>
                            ...
                            <div class="chat-footer">
                                <form action="<?php echo e(route('messages.store', $conversation['user']->user_id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <textarea class="send-message-text" name="content" placeholder="Écrivez un message..."></textarea>
                                    <label class="upload-file">
                                        <input type="file" />
                                        <i class="fa fa-paperclip"></i>
                                    </label>
                                    <button type="submit" class="send-message-button btn-info">
        ...
        <script>
            // Javascript pour changer d'onglet de messages sans recharger la page
            document.querySelectorAll('.conversation-item').forEach(function(item) {
                item.addEventListener('click', function(e) {
                    const userId = this.getAttribute('data-user-id');
                    // Récupérer les messages pour cet utilisateur
                    fetch(`/agence-chat/${userId}`)
                        .then(response => response.json())
                        .then(data => {
                            // Mettre à jour le contenu de l'onglet correspondant
                            const targetTab = document.getElementById('inbox-message-' + userId);
                            targetTab.innerHTML = data.messagesHtml; // Assurez-vous que `data.messagesHtml` contient les messages
                        });
                });
            });
        </script>
...
<?php /**PATH /home/espokeys/BBI/client/web/BBIAPP/BBI/resources/views/messages/Agence/chat-index.blade.php ENDPATH**/ ?>