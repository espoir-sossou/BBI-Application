        ...
        <div class="panel messages-panel " >
            <div class="contacts-list" >
                <div class="inbox-categories">
                    <div data-toggle="tab" data-target="#inbox" class="active">
                        Imbox
                    </div>
                    <div data-toggle="tab" data-target="#sent">Envoyés</div>
                    <div data-toggle="tab" data-target="#marked">Marqués</div>
                    <div data-toggle="tab" data-target="#drafts">Brouillons</div>
                </div>
            ...
            <div class="tab-content">
                <div class="tab-pane message-body active" id="inbox-message-1">
                    <div class="message-top">
                        <a href="/" class="btn btn btn-success new-message">
                            <i class="fa fa-envelope"></i> Page d'Acceuil
                        </a>
                        ...
                        <div class="new-message-wrapper">
                            ...
                            <div class="chat-footer new-message-textarea">
                                ...
                                <button type="button" class="send-message-button btn-info">
                    ...
                    <div class="tab-content">
                        <?php $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="tab-pane" id="inbox-message-<?php echo e($conversation['user']->id); ?>">
                                            ...
                                            <div class="message <?php echo e($message->sender_id === auth()->id() ? 'my-message' : 'info'); ?>">
                                                ...
                                                <div class="message-body">
                                                    <div class="message-info">
                                                        <h4>
                                                            <?php echo e($message->sender_id === auth()->id() ? 'Vous' : $conversation['user']->nom); ?>
...
<?php /**PATH /home/espokeys/BBI/client/web/BBIAPP/BBI/resources/views/messages/chat-index.blade.php ENDPATH**/ ?>