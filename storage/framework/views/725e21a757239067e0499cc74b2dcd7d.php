                ...
                <div class="container">
                    <div class="row properties-box">
                        <?php $__currentLoopData = $annonces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annonce): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($annonce->typeTransaction === 'A vendre'): ?>
                                <!-- Condition pour afficher uniquement les annonces à vendre -->
...
<?php echo $__env->make('Layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/espokeys/BBI/client/web/BBIAPP/BBI/resources/views/Layout/Frontend/Annonce/avendre-page.blade.php ENDPATH**/ ?>