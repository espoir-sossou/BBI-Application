    ...
    <main id="main">
        ...
        <script>
            function initMap() {
                ...
                const annonces = <?php echo json_encode($annonces, 15, 512) ?>; // Conversion des annonces PHP en format JavaScript
...
<?php echo $__env->make('Layout.lending_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/espokeys/BBI/client/web/BBIAPP/BBI/resources/views/map/map-page.blade.php ENDPATH**/ ?>