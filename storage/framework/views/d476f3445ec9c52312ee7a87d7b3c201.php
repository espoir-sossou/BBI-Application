                                ...
                                <div class="item position-relative">
                                    ...
                                    <form action="<?php echo e(route('ajouterAuxFavoris', $annonce->annonce_id)); ?>" method="POST"
                                        ...
                                        <button type="submit" class="btn p-0 border-0"
                                            ...
                                            <i class="fa fa-heart"
                                                style="font-size: 24px; color: <?php echo e($isFavorite ? 'tomato' : '#318093'); ?>; text-shadow: 0 0 5px rgba(0,0,0,0.5); transition: color 0.3s ease;"
                                                onmouseover="this.style.color='tomato';"
                                                onmouseout="this.style.color='<?php echo e($isFavorite ? 'tomato' : '#318093'); ?>';">
                                            </i>
                                    ...
                                    <ul class="list-unstyled d-flex flex-wrap gap-3">
                                        <li>
                                            <i class="fa fa-bed" style="color: #318093; font-size: 18px;"
                                                title="Nombre de chambres"></i>
                                            <span><?php echo e($annonce->nbChambres); ?></span>
                                        </li>
                                        <li>
                                            <i class="fa fa-shower" style="color: #318093; font-size: 18px;"
                                                title="Salles de bain"></i>
                                            <span><?php echo e($annonce->nbSalleDeDouche); ?></span>
                                        </li>
                                        <li>
                                            <i class="fa fa-ruler-combined" style="color: #318093; font-size: 18px;"
                                                title="Superficie"></i>
                                            <span><?php echo e($annonce->superficie); ?> m²</span>
                                        </li>

                                        <li>
                                            <i class="fa fa-car" style="color: #318093; font-size: 18px;"
                                                title="Parking"></i>
...
<?php echo $__env->make('Layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/espokeys/BBI/client/web/BBIAPP/BBI/resources/views/index.blade.php ENDPATH**/ ?>