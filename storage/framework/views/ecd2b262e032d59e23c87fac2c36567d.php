                ...
                <div class="carousel-item h-100 <?php echo e($index === 0 ? 'active' : ''); ?>">
                    <?php if($offre->image): ?>
                        ...
                        <img src="<?php echo e($imagePath); ?>" class="d-block w-100 h-100"
                            ...
                            alt="Image de l'offre en vedette">
                    <?php else: ?>
...
<?php echo $__env->make('Layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/espokeys/BBI/client/web/BBIAPP/BBI/resources/views/Layout/Frontend/Annonce/resultats.blade.php ENDPATH**/ ?>