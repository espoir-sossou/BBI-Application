...
<head>
    ...
    <title><?php echo e($annonceDetail->titre ?? 'Détails de l\'annonce'); ?></title>

    <meta property="og:title" content="<?php echo e($annonceDetail->titre ?? 'Détails de l\'annonce'); ?>">
    <meta property="og:description" content="<?php echo e($annonceDetail->description ?? 'Découvrez notre annonce.'); ?>">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:image"
        content="<?php echo e($annonceDetail->images->isNotEmpty() ? Storage::url($annonceDetail->images->first()->path) : asset('Frontend/Home/assets/imgs/default.jpg')); ?>">
    <meta property="og:type" content="article">
    <meta property="og:site_name" content="Nom de votre site">

    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo e($annonceDetail->titre ?? 'Détails de l\'annonce'); ?>">
    <meta name="twitter:description" content="<?php echo e($annonceDetail->description ?? 'Découvrez notre annonce.'); ?>">
    ...
    document.querySelector('#share-btn').addEventListener('click', function () {
        ...
        <script>
            document.querySelector('#share-btn').addEventListener('click', function() {
                ...
                const image =
                    "<?php echo e($annonceDetail->images->isNotEmpty() ? Storage::url($annonceDetail->images->first()->path) : asset('Frontend/Home/assets/imgs/default.jpg')); ?>";
