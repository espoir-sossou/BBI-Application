    ...
    <div class="container py-5">
        <div class="card shadow-lg">
            ...
            <div class="card-body text-center">
                <h2 class="text-success">Bonjour <?php echo e($prenom); ?> !</h2>
                ...
                <a href="<?php echo e(url('/login-page')); ?>" class="btn-custom mt-3">Se connecter</a>
            </div>
        </div>
...
<?php /**PATH /home/espokeys/BBI/client/web/BBIAPP/BBI/resources/views/emails/signup_confirmation.blade.php ENDPATH**/ ?>