...
<div class="container-fluid mt-3 p-0">
    <div class="row d-flex align-items-center justify-content-between px-xl-5">
      ...
      <div class="col-6 col-md-6 text-center text-md-left">
        <a href="/">
          <img class="img-fluid" src="<?php echo e(asset('Frontend/Home/assets/imgs/logo_bbi.png')); ?>" alt=""
...
<?php /**PATH /home/espokeys/BBI/client/web/BBIAPP/BBI/resources/views/Layout/Frontend/Partials/loginPage/navbar.blade.php ENDPATH**/ ?>