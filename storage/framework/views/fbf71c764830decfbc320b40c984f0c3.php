<?php $__env->startSection('content'); ?>
    ...
    <script>
        // Simuler les notifications push transmises depuis le serveur
        const notifications = <?php echo json_encode($notifications, 15, 512) ?>;
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                            ...
                            <div class="dropdown-header">En-tête du menu :</div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        ...
                        <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> Réseaux sociaux
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-info"></i> Référents
                        </span>
                    </div>
                </div>
            </div>
    ...
    <!-- Page level plugins -->
    <script src="<?php echo e(asset('Frontend/Home/assets/vendor/chart.js/Chart.min.js')); ?>"></script>

    <!-- Page level custom scripts -->
    <script src="<?php echo e(asset('Frontend/Home/assets/js/demo/chart-area-demo.js')); ?>"></script>
    <script src="<?php echo e(asset('Frontend/Home/assets/js/demo/chart-pie-demo.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('Layout.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/espokeys/BBI/client/web/BBIAPP/BBI/resources/views/Layout/Backend/Admin_dashboard/index.blade.php ENDPATH**/ ?>